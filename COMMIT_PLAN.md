...
- **Still open (v0.3.x backlog):** chef + project-2026 opt-ins; GitHub push when distribution is wanted; git `pre-merge-commit`/`pre-push` variant for terminal-typed merges; "Agents (0)" quirk-check via `/review`.
